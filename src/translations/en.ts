export const en = {
  ...
  settings: {
    ...
    email: {
      ...
      expiringResidencies: 'Residencies Expiring Soon',
      expiringDocuments: 'Documents Expiring Soon',
      withinMonth: 'within a month',
      noFileChosen: 'No file chosen',
      checkExpiry: 'Check Expiry',
      checkingExpiry: 'Checking...',
      sendImmediateReport: 'Send Immediate Report',
      sendingReport: 'Sending...',
      enableAutoAlerts: 'Enable Auto Alerts',
      lastEmailSent: 'Last email sent:',
      expiryDetails: 'Expiry Details',
      expiringResidenciesList: 'Expiring Residencies',
      expiringDocumentsList: 'Expiring Documents',
      ...
      status: 'Status',
      actions: 'Actions',
      dayExpired: 'days (Expired)',
      day: 'days',
      expired: 'Expired',
      danger: 'Danger',
      warning: 'Warning',
      moreItemsInReport: 'and {count} more items in full report',
      moreDocumentsInReport: 'and {count} more documents in full report',
      emailConfigNote: 'Important Note about Email Settings',
      emailConfigNotes: {
        verifySmtp: '• Verify SMTP settings before enabling auto-alerts',
        autoAlertsWhen: '• Auto-alerts are sent when:',
        monthBeforeExpiry: '- One month before expiry',
        weekBeforeExpiry: '- One week before expiry',
        actualExpiry: '- Actual expiry date',
        immediateReport: '• An immediate report can be sent anytime using "Send Immediate Report"'
      }
    },
    ...
    backup: {
      ...
      eraseDataDescription: 'Permanently delete all data from the database. This action cannot be undone.',
      eraseButton: 'Erase All Data',
      eraseConfirmTitle: 'Are you absolutely sure?',
      eraseConfirmDescription: 'This will permanently delete ALL data including companies, employees, documents, and settings. This action cannot be undone. Please type "DELETE ALL" to confirm.',
      eraseConfirmPlaceholder: 'Type DELETE ALL',
      eraseCancel: 'Cancel',
      eraseConfirmButton: 'Yes, Erase Everything',
      eraseSuccess: 'All data has been erased successfully',
      eraseError: 'Failed to erase data'
    },
